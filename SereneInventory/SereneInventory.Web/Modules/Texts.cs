    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your SereneInventory Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to Inventory Management System";
                    public static LocalText SignInButton = "Sign In";
                    //ublic static LocalText ForgotPassword = "Forgot password?";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your SereneInventory Account";
                    ...
                    public static LocalText FormTitle = "Sign up for SereneInventory";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "SereneInventory";
        }
        ...
        {
            public static LocalText Name = "IMS";
            public static LocalText Title = "Inventory Management Company";
            public static LocalText Address = "House # 9, Road # 09, Sector # 09, Lahore";
            public static LocalText Contact = "+923414760967, +923055920706";
        }
